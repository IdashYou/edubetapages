...
function decfmt(){if(DecSep==","){fixSpells(document.body,"d");var imgs=document.body.getElementsByTagName("img");for(var i=0;i<img style="max-width:100%" s.length;i++){if(imgs[i].getAttribute("hasdec")!=null&&imgs[i].getAttribute("hasdec")!=""){imgs[i].src=imgs[i].src.replace(/\.(gif|jpg|png)/g,"c.$1");}}}}
...
if(!transQ){var path=location.pathname;path=path.split('/mathsisfun/').join('/');var dir=path.substring(0,path.lastIndexOf('/'));var file=path.substring(path.lastIndexOf('/')+1);var fbQ=false;if(fbQ){path='https://www.facebook.com/Mathisfun-249324325634773/';var newDiv=document.createElement("div");var tgtDiv=document.getElementById("content");document.body.insertBefore(newDiv,tgtDiv);var str='<div style="position: absolute; right: 50%; margin-right: 260px; top:120px; "><a href="https://www.facebook.com/Mathisfun-249324325634773/" rel="nofollow"><img style="max-width:100%"  src="/images/style/facebook.svg"></a></div>';newDiv.innerHTML=str;}}}
...
function putFlash6(w,h,fn,querystring,clr,noflash){var s=getFlash6HTML(w,h,fn,querystring,clr);document.write(s);if(hasFlash()){}else{var s="";if(noflash){s=noflash;}else{s='<a href="/flash-player.html"><img style="max-width:100%"  src="/images/style/no-flash.jpg" alt="Needs Flash Player"></a>';}
...
s+='</ul>';s+='</li>';s+='</ul>';}
if(typ==2){s+='&nbsp;';s+='<a href="javascript:showMenu()" style="text-decoration: none;" aria-label="Show Menu">';s+='<img style="max-width:100%"  src="'+urlStt+'images/style/menu.svg" alt="Menu" />';s+='</a>';s+=' ';s+='<a href="javascript:showSrch()" style="text-decoration: none;" aria-label="Show Search">';s+='<img style="max-width:100%"  src="'+urlStt+'images/style/search.gif" alt="Search" />';s+='</a>';}
return s;}
...
s+=' </div>'
break
case '300x250':s+='<img style="max-width:100%"  src="../images/style/300x250.jpg">'
break
case 'mathtutor':s+=' <div style="height:110px;">'
s+='<a href="http://www.mathtutor.com/index-ad.html"><img style="max-width:100%"  src="/images/ad-mathtutor.gif"></a>'
s+=' </div>'
break
case 'dummy':s+='<img style="max-width:100%"  src="../images/style/320x60.jpg">'
break
...
default:}
return s;}
function getSocial(){if(true)return '';var url=location.href;var title=encodeURIComponent(document.title);var s='';s+='<ul class="share-buttons">';s+='<li><a href="https://www.facebook.com/sharer/sharer.php?u='+url+'&t='+title+'" title="Share on Facebook" target="_blank"><img style="max-width:100%"  src="/mathsisfun/images/style/Facebook.png"></a></li>';s+='<li><a href="https://twitter.com/intent/tweet?source='+url+'&text='+title+':%20'+url+'" target="_blank" title="Tweet"><img style="max-width:100%"  src="/mathsisfun/images/style/Twitter.png"></a></li>';s+='<li><a href="http://pinterest.com/pin/create/button/?url='+url+'&description='+title+'" target="_blank" title="Pin it"><img style="max-width:100%"  src="/mathsisfun/images/style/Pinterest.png"></a></li>';s+='</ul>';return s;}
